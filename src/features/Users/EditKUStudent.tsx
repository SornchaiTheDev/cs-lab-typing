...
import { KUStudentSchema, type TKUStudentSchema } from "~/forms/KUStudentSchema";
...
const EditKUStudent = () => {
  ...
  const editUser = async (formData: TKUStudentSchema) => {
    const { email, full_name, roles, student_id } = formData;
    updateUser.mutate({
      email,
      full_name,
      roles,
